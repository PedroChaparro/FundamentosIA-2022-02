...
const possible_results = {
	...
	'MOTEADO': {
		...
		description:
			'No es un síntoma que caracterice la enfermedad y se presenta independientemente de las pudriciones de flecha-cogollo; sin embargo, palmas con pudriciones de flecha acentúan el síntoma de moteado. Los moteados leves o moderados desaparecen con los cambios de clima y buenas prácticas agronómicas.',
		treatment:
			'1.Revisar cuidadosamente las palmitas de vivero, ante su transplante a sitio definitivo, a fin e eliminar todas aquellas sospechosas de estar infectadas\n\n2.Eliminar especies de gramíneas en los lotes, reemplazándolas por cobertura de pueraria Erradicar las palmas, tan pronto presenten síntomas de la enfermedad\n\n3.Mantener libre de malezas los círculos (zona  de  plateo) de las palma\n\n4.Protección de las palmas, especialmente en el vivero, mediante la aplicación de insecticidas que eliminen posibles vectores de la enfermedad ',
	},
	...
	'DEFICIENCIA DE MAGNESIO': {
		...
		description:
			'Se caracteriza por un  amarillamiento de las hojas de la base del tronco. La deficiencia de este elemento es causada por reservas bajas de él en el suelo, por la presencia de un subsuelo muy ácido y por el desbalance entre el magnesio',
		treatment:
			'El fertilizante más comúnmente empleado para corregir esta deficiencia es el sulfato de magnesio.',
	},
	'PUDRICIÓN DE LOS RACIMOS': {
		...
		treatment:
			'Los racimos infectados deben retirarse de las palmas, así como también los restos de inflorescencias, mediantes podas sanitarias regulares. Cuando sea necesario se realiza la polinización asistida para conseguir un mejor cuajamiento de los frutos, para así disminuir el exceso de humedad ambiental mediante un control de malezas y mejoramientos de las condiciones de drenaje',
	},
};
